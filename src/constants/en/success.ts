export const success = {
	...
	usersFoundSuccessfully: {
		status: 200,
		code: 1003,
		title: "Users found successfully.",
		description: "The users were found successfully."
	},
	...
	saleFoundSuccessfully: {
		status: 200,
		code: 1007,
		title: "Sale found successfully.",
		description: "The sale was found successfully."
	},	
	saleUpdatedSuccessfully: {
		status: 200,
		code: 1008,
	...
	productFoundSuccessfully: {
		status: 200,
		code: 1011,
		title: "Product found successfully.",
		description: "The product was found successfully."
	},
	productsFoundSuccessfully: {
		status: 200,
		code: 1012,
		title: "Products found successfully.",
		description: "The products were found successfully."
	},
